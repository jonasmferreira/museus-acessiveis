...
-- Tempo de Geração: 04/04/2015 às 13:47:09
...
--
-- Estrutura da tabela `tb_clipping_galeria`
--

CREATE TABLE IF NOT EXISTS `tb_clipping_galeria` (
...
(6, '2014-11-07', '00:20:14', 1, 'www.facebook.com/museusacessiveis ', 'https://www.facebook.com/museus.acessiveis?fref=ts', 'S'),
(7, '2014-11-07', '00:20:14', 5, 'viviane@museusacessiveis.com.br', 'viviane@museusacessiveis.com.br', 'S'),
(8, '2014-11-07', '00:20:14', 8, 'Viviane Sarraf', 'www.facebook.com/museusacessiveis ', 'S'),
(9, '2014-11-07', '00:20:14', 6, 'www.museusacessiveis.com.br', 'www.facebook.com/museusacessiveis ', 'S'),
(10, '2014-11-07', '00:20:14', 9, 'Viviane Sarraf', 'https://twitter.com/Criatives', 'S'),
(11, '2014-11-07', '00:20:14', 10, 'Viviane Sarraf', 'www.facebook.com/museusacessiveis ', 'S'),
(12, '2014-11-07', '00:20:14', 3, 'viviane.sarraf', 'www.museusacessiveis.com.br', 'S');
...
(1, 'Facebook', 'S', '20141107073512_botcÂµes_contato-05.png', '20141107073512_botcÂµes_contato-06.png'),
(2, 'Celular', 'S', '20141107073816_botcÂµes_contato-01-01.png', '20141107073816_botcÂµes_contato-02-02.png'),
(3, 'Skype', 'S', '20141107171914_ico_skype.png', '20141107171914_ico_skype_contrast.png'),
(5, 'E-mail', 'S', '20141107074802_botcÂµes_contato-07.png', '20141107074802_botcÂµes_contato-08.png'),
(6, 'Site', 'S', '20141107113715_ico_site.png', '20141107113715_ico_site_contrast.png'),
(7, 'Telefone', 'S', '20141107075137_botcÂµes_contato-01-01.png', '20141107075137_botcÂµes_contato-02-02.png'),
(8, 'Social Media (Linked in)', 'S', '20141107074224_botcÂµes_contato-11.png', '20141107074224_botcÂµes_contato-12.png'),
(9, 'Social Media (Twitter)', 'S', '20141107113745_ico_twitter.png', '20141107113745_ico_twitter_contrast.png'),
(10, 'Social Media (Googlemais)', 'S', '20141107172004_ico_googleplus.png', '20141107172004_ico_googleplus_contrast.png');
...
--
-- Estrutura da tabela `tb_curso_galeria`
--

CREATE TABLE IF NOT EXISTS `tb_curso_galeria` (
...
--
-- Extraindo dados da tabela `tb_curso_galeria`
--

INSERT INTO `tb_curso_galeria` (`curso_galeria_id`, `curso_id`, `galeria_id`) VALUES
(1, 13, 1);
...
CREATE TABLE IF NOT EXISTS `tb_emailmkt` (
  ...
  `emailmkt_noticia_ids` text,
  `emailmkt_exibe_noticia` enum('S','N') NOT NULL,
  `emailmkt_glossario_ids` text NOT NULL,
  `emailmkt_exibe_glossario` enum('S','N') NOT NULL,
  `emailmkt_novidade360_id` bigint(20) NOT NULL,
  `emailmkt_novidade360_ids` text NOT NULL,
  `emailmkt_exibe_novidade360` enum('S','N') NOT NULL,
  `emailmkt_agenda_ids` text NOT NULL,
  `emailmkt_exibe_agenda` enum('S','N') NOT NULL,
  `emailmkt_contato_img` text NOT NULL,
  `emailmkt_contato_email` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT 'emkt_contact_bt.png',
  `emailmkt_arq_fisico` text NOT NULL,
  `emailmkt_exibe_arquivo` enum('S','N') NOT NULL,
  ...
  `emailmkt_exibe_aquitem` enum('S','N') NOT NULL,
  `emailmkt_propaganda_img` text NOT NULL,
  `emailmkt_propaganda_url` text,
  `emailmkt_exibe_propaganda` enum('S','N') NOT NULL,
...
INSERT INTO `tb_emailmkt` (`emailmkt_id`, `emailmkt_titulo`, `emailmkt_qtde_enviada`, `emailmkt_dt_agendada`, `emailmkt_hr_agendada`, `emailmkt_dt_disparo`, `emailmkt_hr_disparo`, `emailmkt_status`, `emailmkt_noticia_ids`, `emailmkt_exibe_noticia`, `emailmkt_glossario_ids`, `emailmkt_exibe_glossario`, `emailmkt_novidade360_id`, `emailmkt_novidade360_ids`, `emailmkt_exibe_novidade360`, `emailmkt_agenda_ids`, `emailmkt_exibe_agenda`, `emailmkt_contato_img`, `emailmkt_contato_email`, `emailmkt_arq_fisico`, `emailmkt_exibe_arquivo`, `emailmkt_aqui_tem_titulo`, `emailmkt_aqui_tem_resumo`, `emailmkt_aqui_tem_thumb`, `emailmkt_aqui_tem_url`, `emailmkt_exibe_aquitem`, `emailmkt_propaganda_img`, `emailmkt_propaganda_url`, `emailmkt_exibe_propaganda`) VALUES
(5, 'Um tÃ­tulo para o newsletter inteligente', 0, '2014-11-07', '02:00:00', NULL, NULL, 'P', '1', 'S', '4', 'S', 7, '17,14', 'S', '10=>N,11=>N,16=>N', 'S', '', '', '', '', 'Aqui tem - notÃ­cia ninja', 'Resumo do aqui tem.', '20141102200415_emkt_aquitem_imagem.jpg', 'http://www.uol.com.br', 'S', '20141102200809_emkt_imagem.png', 'http://www.terra.com.br', 'S'),
(6, 'Chegou', 0, '2014-12-02', '00:00:00', NULL, NULL, 'P', '', '', '8', 'S', 0, '', '', '', '', 'emkt_contact_bt.png', 'fessorjoao@gmail.com', '', '', '', '', '', '', '', '20150323065937_drops_10-01.png', 'http://facebook.com.br', 'S'),
(7, 'teste 3', 0, '0000-00-00', '00:00:00', NULL, NULL, 'P', '1', 'S', '15', 'S', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(8, 'ooooo', 0, '2014-11-28', '00:00:00', NULL, NULL, 'P', '1', 'S', '', '', 0, '', '', '', '', 'emkt_contact_bt.png', 'viviane@museusacessÃ­veis.com.br', '', '', '', '', '', '', '', '', '', '');
...
--
-- Estrutura da tabela `tb_emailmkt_old`
--

CREATE TABLE IF NOT EXISTS `tb_emailmkt_old` (
  ...
  `emailmkt_servico_ids` text CHARACTER SET latin1 NOT NULL,
  `emailmkt_projeto_ids` text CHARACTER SET latin1 NOT NULL,
...
--
-- Extraindo dados da tabela `tb_emailmkt_old`
--

INSERT INTO `tb_emailmkt_old` (`emailmkt_id`, `emailmkt_titulo`, `emailmkt_qtde_enviada`, `emailmkt_dt_agendada`, `emailmkt_hr_agendada`, `emailmkt_dt_disparo`, `emailmkt_hr_disparo`, `emailmkt_status`, `emailmkt_servico_ids`, `emailmkt_projeto_ids`, `emailmkt_glossario_ids`, `emailmkt_novidade360_id`, `emailmkt_novidade360_ids`, `emailmkt_agenda_ids`, `emailmkt_arq_fisico`, `emailmkt_aqui_tem_titulo`, `emailmkt_aqui_tem_resumo`, `emailmkt_aqui_tem_thumb`, `emailmkt_aqui_tem_url`, `emailmkt_propaganda_img`, `emailmkt_propaganda_url`) VALUES
...
--
-- Estrutura da tabela `tb_emkt_noticia`
--

CREATE TABLE IF NOT EXISTS `tb_emkt_noticia` (
...
--
-- Extraindo dados da tabela `tb_emkt_noticia`
--

INSERT INTO `tb_emkt_noticia` (`emkt_noticia_id`, `emkt_noticia_dt`, `emkt_noticia_hr`, `emkt_noticia_titulo`, `emkt_noticia_titulo_sintese`, `emkt_noticia_resumo`, `emkt_noticia_thumb`, `emkt_noticia_thumb_desc`, `emkt_noticia_fonte`, `emkt_noticia_url_fonte`, `emkt_noticia_conteudo`) VALUES
(1, '2014-11-01', '12:59:42', 'Uma notÃ­cia para o Newsletter', 'NotÃ­cia exclusiva', 'Uma notÃ­cia exclusiva para o newsletter apenas', '20141103083530_homedoemailmkt.jpg', 'A descriÃ§Ã£o do thumb que vamos usar.', 'Omelete', 'http://www.omelete.com.br', '<p>\r\n	Aqui vai todo o conte&uacute;do da not&iacute;cia</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	adfasdfdsfdsa</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	e lorem ipsum e fim.</p>\r\n');
...
INSERT INTO `tb_galeria` (`galeria_id`, `galeria_titulo`, `galeria_descricao`, `galeria_resumo`) VALUES
(1, 'Super imagens', 'super super', 'super supersuper supersuper supersuper supersuper supersuper super'),
(2, 'Fotos de Ã³culos para dauntÃ´nicos', '', ''),
(3, 'moda', 'moda', '');
...
CREATE TABLE IF NOT EXISTS `tb_galeria_imagem` (
  `galeria_imagem_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `galeria_id` bigint(20) unsigned NOT NULL,
  `galeria_imagem_arq` text COLLATE latin1_general_ci NOT NULL,
  `galeria_imagem_titulo` varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  `galeria_imagem_descricao` text COLLATE latin1_general_ci,
  PRIMARY KEY (`galeria_imagem_id`),
  KEY `fk_galeria_imagem_01_idx` (`galeria_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=17 ;

--
-- Extraindo dados da tabela `tb_galeria_imagem`
--

INSERT INTO `tb_galeria_imagem` (`galeria_imagem_id`, `galeria_id`, `galeria_imagem_arq`, `galeria_imagem_titulo`, `galeria_imagem_descricao`) VALUES
(1, 1, '20141106121552_novidades.jpg', 'Cozinha', 'cozinha acessivel cozinha acessivel cozinha acessivel cozinha acessivel cozinha acessivel '),
(2, 1, '20141106121552_emkt_aquitem_imagem.jpg', 'Hellen', 'helen keller helen keller helen keller helen keller helen keller '),
(3, 1, '20141106121552_outdoor_dest.jpg', 'AcessÃ­vel', 'cozinha acessivel cozinha acessivel cozinha acessivel cozinha acessivel cozinha acessivel '),
(4, 2, '20150316191711_images-2.jpeg', '', 'imagem azul'),
(5, 2, '20150316191711_images-3.jpeg', '', 'imagem amarela'),
(6, 2, '20150316191711_images-4.jpeg', '', 'imagem roxa'),
(7, 2, '20150316191711_images-5.jpeg', '', 'imagem verde'),
(8, 2, '20150316191711_images-6.jpeg', '', 'imagem preta'),
(9, 2, '20150316191711_images-7.jpeg', '', 'imagem lilÃ¡s'),
(10, 3, '20150323072231_imagens_gal001.jpg', '', ''),
(11, 3, '20150323072231_imagens_gal002.jpg', '', ''),
(12, 3, '20150323072231_imagens_gal003.jpg', '', ''),
(13, 3, '20150323072231_imagens_gal004.png', '', ''),
(14, 3, '20150323072231_imagens_gal005.png', '', ''),
(15, 3, '20150323072231_imagens_gal006.png', '', ''),
(16, 3, '20150323072231_imagens_gal007.png', '', '');
...
(15, '2014-11-07', '06:59:30', 'Surdo', 'faskljflasd;lfjasdlkfjals', '', '', '<p>\r\n	sdfkaslkdfjlas alskdjf laksjf al alksdj alkja ldk alkdsfj al</p>\r\n', 'S');
...
(16, '2014-09-26', 'S', '2014-11-12', '08:04:39', 'Dia Nacional do Surdo', 'Dia Nacional do Surdo', 'Durante todo o mÃªs setembro sÃ£o realizados diversos eventos, tais como: festas dos alunos surdos, seminÃ¡rios, palestras, apresentaÃ§Ãµes teatrais, passeatas, audiÃªncias pÃºblicas, exposiÃ§Ãµes, caminhada, encontro dos Surdos etc. em todas as cidades do Brasil. A Comunidade Surda chama de "Setembro Azul", a data para a comemoraÃ§Ã£o do Dia do Surdo Ã© dia 26 de setembro, foi reconhecido e assinado pelo Ex-Presidente do Brasil Luis InÃ¡cio Lula da Silva com o nÃºmero de Lei NÂº 11.796 de 29 de outubro de 2008. Surdo', '', '', 'Revista ReaÃ§Ã£o', 'http://www.revistareacao.com.br/', '<p>\r\n	Durante todo o m&ecirc;s setembro s&atilde;o realizados diversos eventos, tais como: festas dos alunos surdos, semin&aacute;rios, palestras, apresenta&ccedil;&otilde;es teatrais, passeatas, audi&ecirc;ncias p&uacute;blicas, exposi&ccedil;&otilde;es, caminhada, encontro dos Surdos etc. em todas as cidades do Brasil. A Comunidade Surda chama de &quot;Setembro Azul&quot;, a data para a comemora&ccedil;&atilde;o do Dia do Surdo &eacute; dia 26 de setembro, foi reconhecido e assinado pelo Ex-Presidente do Brasil Luis In&aacute;cio Lula da Silva com o n&uacute;mero de Lei N&ordm; 11.796 de 29 de outubro de 2008. Surdo. Daisy</p>\r\n<p>\r\n	Durante todo o m&ecirc;s setembro s&atilde;o realizados diversos eventos, tais como: festas dos alunos surdos, semin&aacute;rios, palestras, apresenta&ccedil;&otilde;es teatrais, passeatas, audi&ecirc;ncias p&uacute;blicas, exposi&ccedil;&otilde;es, caminhada, encontro dos Surdos etc. em todas as cidades do Brasil. A Comunidade Surda chama de &quot;Setembro Azul&quot;, a data para a comemora&ccedil;&atilde;o do Dia do Surdo &eacute; dia 26 de setembro, foi reconhecido e assinado pelo Ex-Presidente do Brasil Luis In&aacute;cio Lula da Silva com o n&uacute;mero de Lei N&ordm; 11.796 de 29 de outubro de 2008.</p>\r\n<p>\r\n	Durante todo o m&ecirc;s setembro s&atilde;o realizados diversos eventos, tais como: festas dos alunos surdos, semin&aacute;rios, palestras, apresenta&ccedil;&otilde;es teatrais, passeatas, audi&ecirc;ncias p&uacute;blicas, exposi&ccedil;&otilde;es, caminhada, encontro dos Surdos etc. em todas as cidades do Brasil. A Comunidade Surda chama de &quot;Setembro Azul&quot;, a data para a comemora&ccedil;&atilde;o do Dia do Surdo &eacute; dia 26 de setembro, foi reconhecido e assinado pelo Ex-Presidente do Brasil Luis In&aacute;cio Lula da Silva com o n&uacute;mero de Lei N&ordm; 11.796 de 29 de outubro de 2008. Surdo</p>\r\n<p>\r\n	Durante todo o m&ecirc;s setembro s&atilde;o realizados diversos eventos, tais como: festas dos alunos surdos, semin&aacute;rios, palestras, apresenta&ccedil;&otilde;es teatrais, passeatas, audi&ecirc;ncias p&uacute;blicas, exposi&ccedil;&otilde;es, caminhada, encontro dos Surdos etc. em todas as cidades do Brasil. A Comunidade Surda chama de &quot;Setembro Azul&quot;, a data para a comemora&ccedil;&atilde;o do Dia do Surdo &eacute; dia 26 de setembro, foi reconhecido e assinado pelo Ex-Presidente do Brasil Luis In&aacute;cio Lula da Silva com o n&uacute;mero de Lei N&ordm; 11.796 de 29 de outubro de 2008. Surdo</p>\r\n<p>\r\n	Durante todo o m&ecirc;s setembro s&atilde;o realizados diversos eventos, tais como: festas dos alunos surdos, semin&aacute;rios, palestras, apresenta&ccedil;&otilde;es teatrais, passeatas, audi&ecirc;ncias p&uacute;blicas, exposi&ccedil;&otilde;es, caminhada, encontro dos Surdos etc. em todas as cidades do Brasil. A Comunidade Surda chama de &quot;Setembro Azul&quot;, a data para a comemora&ccedil;&atilde;o do Dia do Surdo &eacute; dia 26 de setembro, foi reconhecido e assinado pelo Ex-Presidente do Brasil Luis In&aacute;cio Lula da Silva com o n&uacute;mero de Lei N&ordm; 11.796 de 29 de outubro de 2008. Daisy</p>\r\n', 'N', '', '', 'S', '', '', ''),
...
(18, '2014-10-02', 'S', '2015-03-23', '07:23:02', 'Setembro Azul', 'Setembro Azul serÃ¡ comemorado com eventos es', 'As atividades da Semana Setembro Azul 2014 ocorerrÃ£o no MAM-SP, ItaÃº Cultural, Pinacoteca do Estado, Museu Afro Brasil e em diversas EMEBS da capital paulista.', '20140908162912_download.jpg', 'Logotipo do Dia Nacional do Surdo. Desenho de duas silhuetas de mÃ£os espalmadas azuis com uma fita azul formando um laÃ§o sobre elas. Frase: Dia Nacional do Surdo 26 de setembro.', 'Cultura Surda', 'culturasurda.net', '<p>\r\n	As atividades da Semana Setembro Azul 2014 ocorerr&atilde;o no MAM-SP, Ita&uacute; Cultural, Pinacoteca do Estado, Museu Afro Brasil e em diversas EMEBS da capital paulista.</p>\r\n<p>\r\n	Acessibilidade acessibilidade</p>\r\n', 'N', '', '', 'N', '', '', ''),
(19, '0000-00-00', 'S', '2015-03-16', '19:18:19', 'Ã“culos para dautÃ´nicos - Uma grande novidade', 'Ã“culos para dautÃ´nicos', 'Uma nova tecnologia de revestimento Ã³ptico permite que as lentes desses Ã³culos filtrem frequÃªncias de luz especÃ­ficas para melhorar a distinÃ§Ã£o das cores por portadores das formas mais comuns de daltonismo. O EnChroma Cx-D Ã© indicado para quem sofre de deuteranomalia e tem dificuldades em diferenciar a cor verde. JÃ¡ o modelo Cx-PT foi projetado especialmente para compensar a protanomalia, confusÃ£o entre o vermelho e preto. Ambos podem ser encontrados por 600 dÃ³lares cada, no www.enchroma.com. No caso de dÃºvida sobre qual modelo usar, no site hÃ¡ um teste gratuito de daltonismo.', '', 'Uma nova tecnologia de revestimento Ã³ptico permite que as lentes desses Ã³culos filtrem frequÃªncias de luz especÃ­ficas para melhorar a distinÃ§Ã£o das cores por portadores das formas mais comuns de daltonismo. O EnChroma Cx-D Ã© indicado para quem sofr', 'Enchroma', 'http://www.enchroma.com/test/instructions/', '<div>\r\n	Uma nova tecnologia de revestimento &oacute;ptico permite que as lentes desses &oacute;culos filtrem frequ&ecirc;ncias de luz espec&iacute;ficas para melhorar a distin&ccedil;&atilde;o das cores por portadores das formas mais comuns de daltonismo. O EnChroma Cx-D &eacute; indicado para quem sofre de deuteranomalia e tem dificuldades em diferenciar a cor verde. J&aacute; o modelo Cx-PT foi projetado especialmente para compensar a protanomalia, confus&atilde;o entre o vermelho e preto. Ambos podem ser encontrados por 600 d&oacute;lares cada, no www.enchroma.com. No caso de d&uacute;vida sobre qual modelo usar, no site h&aacute; um teste gratuito de daltonismo.</div>\r\n<div>\r\n	&nbsp;</div>\r\n<div>\r\n	Uma nova tecnologia de revestimento &oacute;ptico permite que as lentes desses &oacute;culos filtrem frequ&ecirc;ncias de luz espec&iacute;ficas para melhorar a distin&ccedil;&atilde;o das cores por portadores das formas mais comuns de daltonismo. O EnChroma Cx-D &eacute; indicado para quem sofre de deuteranomalia e tem dificuldades em diferenciar a cor verde. J&aacute; o modelo Cx-PT foi projetado especialmente para compensar a protanomalia, confus&atilde;o entre o vermelho e preto. Ambos podem ser encontrados por 600 d&oacute;lares cada, no www.enchroma.com. No caso de d&uacute;vida sobre qual modelo usar, no site h&aacute; um teste gratuito de daltonismo.</div>\r\n<div>\r\n	&nbsp;</div>\r\n<div>\r\n	Uma nova tecnologia de revestimento &oacute;ptico permite que as lentes desses &oacute;culos filtrem frequ&ecirc;ncias de luz espec&iacute;ficas para melhorar a distin&ccedil;&atilde;o das cores por portadores das formas mais comuns de daltonismo. O EnChroma Cx-D &eacute; indicado para quem sofre de deuteranomalia e tem dificuldades em diferenciar a cor verde. J&aacute; o modelo Cx-PT foi projetado especialmente para compensar a protanomalia, confus&atilde;o entre o vermelho e preto. Ambos podem ser encontrados por 600 d&oacute;lares cada, no www.enchroma.com. No caso de d&uacute;vida sobre qual modelo usar, no site h&aacute; um teste gratuito de daltonismo:</div>\r\n', 'N', '', '', 'N', '', '', '');
...
--
-- Estrutura da tabela `tb_novidade_360_galeria`
--

CREATE TABLE IF NOT EXISTS `tb_novidade_360_galeria` (
  `novidade_galeria_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `novidade_360_id` bigint(19) unsigned NOT NULL,
  `galeria_id` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`novidade_galeria_id`),
  KEY `FK_tb_novidade_360_galeria_1` (`galeria_id`),
  KEY `FK_tb_novidade_360_galeria_2` (`novidade_360_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;

--
-- Extraindo dados da tabela `tb_novidade_360_galeria`
--

INSERT INTO `tb_novidade_360_galeria` (`novidade_galeria_id`, `novidade_360_id`, `galeria_id`) VALUES
(4, 16, 1),
(5, 19, 2),
(6, 18, 3);
...
--
-- Estrutura da tabela `tb_projeto_galeria`
--

CREATE TABLE IF NOT EXISTS `tb_projeto_galeria` (
...
--
-- Estrutura da tabela `tb_release_galeria`
--

CREATE TABLE IF NOT EXISTS `tb_release_galeria` (
...
--
-- Estrutura da tabela `tb_servico_galeria`
--

CREATE TABLE IF NOT EXISTS `tb_servico_galeria` (
...
(2, '2014-11-09', '20:55:13', '<p class="p1">\r\n	Seguem algumas dicas para facilitar a navega&ccedil;&atilde;o:</p>\r\n<p class="p1">\r\n	&nbsp;</p>\r\n<p class="p1">\r\n	TAB (navega entre os links)</p>\r\n<p class="p1">\r\n	&nbsp;</p>\r\n<p class="p1">\r\n	CTRL+1 (barra de acessibilidade)</p>\r\n<p class="p1">\r\n	&nbsp;</p>\r\n<p class="p1">\r\n	CTRL+2 (menu)</p>\r\n<p class="p1">\r\n	&nbsp;</p>\r\n<p class="p1">\r\n	CTRL+3 (conte&uacute;do)</p>\r\n<p class="p1">\r\n	&nbsp;</p>\r\n<p class="p1">\r\n	CTRL+4 (contatos).<br />\r\n	&nbsp;</p>\r\n<p class="p1">\r\n	<strong>Dica: </strong>As palavras escritas entre colchetes se referem a verbetes do Gloss&aacute;rio de Acessibilidade. Clique sobre elas para acessar as informa&ccedil;&otilde;es do verbete.</p>\r\n<p class="p1">\r\n	&nbsp;</p>\r\n<p class="p1">\r\n	<strong>Acessibilidade no Newsletter do Museus Acess&iacute;veis: </strong><br />\r\n	Por quest&otilde;es de seguran&ccedil;a todas as fun&ccedil;&otilde;es de acessibilidade s&atilde;o bloqueadas no Newsletter, quando este for acessado pelo seu cliente de e-mail (Gmail, Yahoo, Webmail UOL, Webmail Terra etc). Isto ocorre pois as fun&ccedil;&otilde;es s&atilde;o ativadas utilizando-se de algor&iacute;timos Javascript.<br />\r\n	Os programas leitores de e-mail bloqueiam qualquer script de javascript para evitar que comandos indesejados, geralmente v&iacute;rus e spywares, possam danificar seu computador.<br />\r\n	Para ter acesso a todas as fun&ccedil;&otilde;es de acessibilidade do newsletter, basta abrir o newsletter no seu programa de internet favorito (Internet Explorer, Google Chrome, Mozilla Firefox etc).<br />\r\n	Pedimos desculpas pelo transtorno.</p>\r\n<p class="p1">\r\n	&nbsp;</p>\r\n');
...
--
-- Restrições para a tabela `tb_clipping_galeria`
--
ALTER TABLE `tb_clipping_galeria`
  ADD CONSTRAINT `FK_tb_clipping_galeria_1` FOREIGN KEY (`galeria_id`) REFERENCES `tb_galeria` (`galeria_id`),
  ADD CONSTRAINT `FK_tb_clipping_galeria_2` FOREIGN KEY (`clipping_id`) REFERENCES `tb_clipping` (`clipping_id`);
...
--
-- Restrições para a tabela `tb_curso_galeria`
--
ALTER TABLE `tb_curso_galeria`
  ADD CONSTRAINT `FK_tb_curso_galeria_1` FOREIGN KEY (`galeria_id`) REFERENCES `tb_galeria` (`galeria_id`),
  ADD CONSTRAINT `FK_tb_curso_galeria_2` FOREIGN KEY (`curso_id`) REFERENCES `tb_curso` (`curso_id`);
...
--
-- Restrições para a tabela `tb_novidade_360_galeria`
--
ALTER TABLE `tb_novidade_360_galeria`
  ADD CONSTRAINT `FK_tb_novidade_360_galeria_1` FOREIGN KEY (`galeria_id`) REFERENCES `tb_galeria` (`galeria_id`),
  ADD CONSTRAINT `FK_tb_novidade_360_galeria_2` FOREIGN KEY (`novidade_360_id`) REFERENCES `tb_novidade_360` (`novidade_360_id`);
...
--
-- Restrições para a tabela `tb_projeto_galeria`
--
ALTER TABLE `tb_projeto_galeria`
  ADD CONSTRAINT `FK_tb_projeto_galeria_1` FOREIGN KEY (`galeria_id`) REFERENCES `tb_galeria` (`galeria_id`),
  ADD CONSTRAINT `FK_tb_projeto_galeria_2` FOREIGN KEY (`projeto_id`) REFERENCES `tb_projeto` (`projeto_id`);
...
--
-- Restrições para a tabela `tb_release_galeria`
--
ALTER TABLE `tb_release_galeria`
  ADD CONSTRAINT `FK_tb_release_galeria_1` FOREIGN KEY (`galeria_id`) REFERENCES `tb_galeria` (`galeria_id`),
  ADD CONSTRAINT `FK_tb_release_galeria_2` FOREIGN KEY (`release_id`) REFERENCES `tb_release` (`release_id`);
...
--
-- Restrições para a tabela `tb_servico_galeria`
--
ALTER TABLE `tb_servico_galeria`
  ADD CONSTRAINT `FK_tb_servico_galeria_1` FOREIGN KEY (`galeria_id`) REFERENCES `tb_galeria` (`galeria_id`),
  ADD CONSTRAINT `FK_tb_servico_galeria_2` FOREIGN KEY (`servico_id`) REFERENCES `tb_servico` (`servico_id`);

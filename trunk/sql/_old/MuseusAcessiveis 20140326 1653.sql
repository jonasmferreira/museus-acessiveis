...
INSERT INTO `tb_anunciante` (`anunciante_id`,`anunciante_dt`,`anunciante_hr`,`anunciante_nome`,`anunciante_tipo_banner`,`anunciante_banner`,`anunciante_banner_desc`,`anuncianete_banner_link`,`anunciante_dt_agenda`) VALUES 
 (1,'2014-03-24','22:23:47','Teste 1','FB','20140325015055_fullbanner.jpg','DescriÃ§Ã£o do fullbanner','http://www.uol.com.br','2014-03-18'),
 (2,'2014-03-24','22:24:17','Teste 2','FB','20140325015115_fullbanner.jpg','outro banner','http://www.google.com.br','2014-03-19'),
 (3,'2014-03-24','22:24:44','Teste 3','RE','20140325015137_banner_item.jpg','o terceiro banner','http://www.google.com.br','2014-03-21'),
 (4,'2014-03-24','22:25:10','Teste 4','RE','20140325015154_banner_item.jpg','lala lalala ','http://www.yahoo.com.br','2014-03-28'),
 (5,'2014-03-24','22:55:16','Teste final','FB','20140325015516_fullbanner.jpg','lal l al l l la llalalala','http://www.yahoo.com.br','2014-03-28');
...
INSERT INTO `tb_anunciante_tag` (`anunciante_id`,`tag_id`) VALUES 
 (2,1),
 (3,1),
 (1,2),
 (5,2);
...
CREATE TABLE `tb_curso` (
  ...
  KEY `fk_tb_curso_1_idx` (`tipo_curso_id`),
  CONSTRAINT `fk_tb_curso_1` FOREIGN KEY (`tipo_curso_id`) REFERENCES `tb_tipo_curso` (`tipo_curso_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tb_curso` (`curso_id`,`tipo_curso_id`,`curso_dt_cad`,`curso_hr_cad`,`curso_dt_ini`,`curso_dt_fim`,`curso_sob_demanda`,`curso_titulo`,`curso_resumo`,`curso_thumb`,`curso_thumb_desc`,`curso_fonte`,`curso_link_fonte`,`curso_conteudo`,`curso_agenda`) VALUES 
 (1,2,'2014-03-22','13:52:56','2014-03-23','2014-03-31','N','Acessibilidade online','Aqui vai o resumo do curso','20140322184409_novidades.jpg','Aqui vai o resumo do curso','Stocco Art & Design','http://stoccoartedesign.wix.com/stoccoartedesign','<p>\r\n	Aqui vai o conte&uacute;do do curso, inclusive com as imagens que eu vou colocar...</p>\r\n<p>\r\n	<img alt=\"\" src=\"http://localhost/MuseusAcessiveis/imgs_rich/images/Calendario_Capa.jpg\" style=\"width: 270px; height: 350px; float: left;\" /></p>\r\n<p>\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	<br />\r\n	E depois mais texto ainda.</p>\r\n','2014-03-24'),
 (2,1,'2014-03-22','20:54:42','0000-00-00','0000-00-00','N','Um curso teste','aqui vai o resumo do curso','20140326180817_novidades.jpg','aqui vai o resumo do curso','','','<p>\r\n	aqui vai o conteudo hahah lelel</p>\r\n','2014-02-10');
...
INSERT INTO `tb_download` (`download_id`,`download_titulo`,`download_tipo`,`download_tamanho`,`download_arquivo`,`download_dt`,`download_hr`) VALUES 
 (1,'Arquivo PDF',1,'114450.00','20140325132950_abril_lista_geral_de_prerÂ§os.pdf','2014-03-25','10:29:50'),
 (2,'fidalgo',1,'389073.00','20140325133012_20110826-fidalgo_antonio_logica_comunicacao.pdf','2014-03-25','10:30:12'),
 (4,'Tabela de preÃ§os abril',2,'30579.00','20140325133049_abril_lista_geral_de_prerÂ§os.docx','2014-03-25','10:30:49'),
 (5,'Entrevista com Chris Peter',2,'21387.00','20140325133115_entrevista_que_josro_abrrco_fez_comigo_para_a_matroria.docx','2014-03-25','10:31:15'),
 (6,'Capa do calendÃ¡rio',4,'35915.00','20140325133152_calendario_capa.jpg','2014-03-25','10:31:52'),
 (8,'em excel para teste',5,'0.00','','2014-03-25','13:23:23');
...
INSERT INTO `tb_imprensa` (`imprensa_id`,`imprensa_titulo`,`imprensa_tipo`,`imprensa_tamanho`,`imprensa_arquivo`,`imprensa_dt`,`imprensa_hr`) VALUES 
 (1,'Um pdf de teste',1,'114450.00','20140325132829_abril_lista_geral_de_prerÂ§os.pdf','2014-03-25','10:28:29'),
 (2,'Um doc de teste',2,'30579.00','20140325132849_abril_lista_geral_de_prerÂ§os.docx','2014-03-25','10:28:49'),
 (3,'Um livro em PDF hahah',1,'389073.00','20140325132923_20110826-fidalgo_antonio_logica_comunicacao.pdf','2014-03-25','10:29:23');
...
INSERT INTO `tb_novidade_360` (`novidade_360_id`,`novidade_360_dt_agenda`,`novidade_360_dt`,`novidade_360_hr`,`novidade_360_titulo`,`novidade_360_resumo`,`novidade_360_thumb`,`novidade_360_thumb_desc`,`novidade_360_fonte`,`novidade_360_url_fonte`,`novidade_360_conteudo`,`novidade_360_exibir_banner`,`novidade_360_banner`,`novidade_360_banner_desc`,`novidade_360_exibir_destaque_home`,`novidade_360_destaque_home`,`novidade_360_destaque_home_desc`,`novidade_360_destaque_home_frase`) VALUES 
 ...
 (3,'2014-02-20','2014-03-23','23:07:20','Mais uma novidade','um resumo lalala','20140323201925_novidades.jpg','descriÃ§Ã£o do thumb lalal','Google','www.google.com.br','<p>\r\n	Aqui o texto completo...</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	fsa</p>\r\n<p>\r\n	fds</p>\r\n<p>\r\n	d</p>\r\n<p>\r\n	fd</p>\r\n<p>\r\n	fim.</p>\r\n','S','20140323230720_outdoor_dest4.jpg','lalalala ','S','20140323201925_destaque.jpg','destaque lalala','a frase final de efeito'),
 (4,'2014-02-17','2014-03-23','17:27:27','quarta novidade','quartanovidad dfasdfds','20140323202727_novidades.jpg','descriÃ§Ã£o da novidade','Uol','www.uol.com.br','<p>\r\n	vamos ver como &eacute; que funciona tudo.</p>\r\n','N','','','N','','',''),
 (5,'2014-01-12','2014-03-25','17:26:10','Testando o GlossÃ¡rio','lelelele','20140323203237_novidades.jpg','lliilii','hahahh','www.hahaha.com','<p>\r\n	llololocsd ISO losdd lfosd&nbsp; skdfsdk&nbsp; sdkfdsk fsd</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	fasdfdsfsd</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	dfasd</p>\r\n<p>\r\n	Acessibilidade hahahaha</p>\r\n<p>\r\n	ISO outra vez ahahahah</p>\r\n<p>\r\n	fim</p>\r\n','N','','','N','','','');
...
INSERT INTO `tb_projeto` (`projeto_id`,`projeto_dt_cad`,`projeto_hr_cad`,`projeto_dt_ini`,`projeto_dt_fim`,`projeto_sob_demanda`,`projeto_tipo`,`projeto_titulo`,`projeto_resumo`,`projeto_thumb`,`projeto_thumb_desc`,`projeto_fonte`,`projeto_link_fonte`,`projeto_agenda`,`projeto_conteudo`) VALUES 
 (1,'2014-03-26','12:12:42','2014-03-23','2014-04-16','N','R','Realizado 1','aqui o resumo basico 1','20140326151242_novidades.jpg','aqui o resumo basico 1','Museus AcessÃ­veis','http://www.museusacessiveis.com.br','2014-03-17','<p>\r\n	Aqui vai o conteudo completo</p>\r\n'),
 (2,'2014-03-26','12:13:43','2014-03-10','2014-03-31','N','EA','Em andamento 1','jjh khyuiyuy l li uul','20140326151343_novidades.jpg','jjh khyuiyuy l li uul','','','2014-03-20','<p>\r\n	fakdf&nbsp; sddkf sdksd f</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	ds</p>\r\n<p>\r\n	f sd</p>\r\n<p>\r\n	f sd</p>\r\n<p>\r\n	f sd</p>\r\n<p>\r\n	fim</p>\r\n'),
 (3,'2014-03-26','12:14:55','0000-00-00','0000-00-00','S','A','Aberto 1','mais resumo','20140326151455_novidades.jpg','mais resumo','Museus AcessÃ­veis','http://www.museusacessiveis.com.br','2014-03-30','<p>\r\n	asdfjksdjf&nbsp; e9 fwe9rue9 kmcx&nbsp;&nbsp; adiofsd fksa fadjasjdg sayuf ax</p>\r\n<p>\r\n	ds</p>\r\n<p>\r\n	f sad</p>\r\n<p>\r\n	f sd</p>\r\n<p>\r\n	&nbsp;fsd</p>\r\n<p>\r\n	&eacute; isso.</p>\r\n'),
 (4,'2014-03-26','12:17:58','0000-00-00','0000-00-00','S','R','Realizado 2','agora vai','20140326151758_novidades.jpg','agora vai','','','2014-03-13','<p>\r\n	fadskjf sd&ccedil;kfl asifweor uweu cxmz xv,m xxvnxz,cx</p>\r\n<p>\r\n	vx</p>\r\n<p>\r\n	vxcz</p>\r\n<p>\r\n	v xc</p>\r\n<p>\r\n	v xcz</p>\r\n<p>\r\n	vcvxcv</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	xcvxc</p>\r\n<p>\r\n	v cx</p>\r\n'),
 (5,'2014-03-26','12:18:50','2014-04-01','2014-04-24','N','A','Aberto 2','ldk riotwdjv xczbmfcg esfsv,','20140326151850_novidades.jpg','ldk riotwdjv xczbmfcg esfsv,','Museus AcessÃ­veis','http://www.museusacessiveis.com.br','2014-04-01','<p>\r\n	cbmznvzxcmc nmnsdajhfudsfhsd&nbsp; fesfesar7e8rwew7464287</p>\r\n'),
 (6,'2014-03-26','12:20:01','2014-05-14','2014-07-30','N','EA','Em andamento 2','38574398 sdajkfhdjhf dkjskj dsfd xnbzcn b \\dxbhd\\ ','20140326152001_novidades.jpg','38574398 sdajkfhdjhf dkjskj dsfd xnbzcn b \\\\dxbhd\\\\ ','','','2014-03-28','<p>\r\n	skjf hakd sdlds[fdsfd</p>\r\n<p>\r\n	fsd</p>\r\n<p>\r\n	f</p>\r\n<p>\r\n	sdf a</p>\r\n<p>\r\n	ds f</p>\r\n<p>\r\n	df d</p>\r\n<p>\r\n	sf sdfd mais um</p>\r\n'),
 (7,'2014-03-26','12:21:06','0000-00-00','0000-00-00','S','A','Aberto 3','mais um aberto','20140326152106_novidades.jpg','mais um aberto','Museus AcessÃ­veis','http://www.museusacessiveis.com.br','2014-04-17','<p>\r\n	sdf hdsfdjsf</p>\r\n<p>\r\n	f sd</p>\r\n<p>\r\n	f</p>\r\n<p>\r\n	dsaberto 123456</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	df</p>\r\n<p>\r\n	das</p>\r\n<p>\r\n	fim.</p>\r\n');
...
CREATE TABLE `tb_servico` (
  ...
  KEY `fk_tb_servico_1_idx` (`tipo_servico_id`),
  CONSTRAINT `fk_tb_servico_1` FOREIGN KEY (`tipo_servico_id`) REFERENCES `tb_tipo_servico` (`tipo_servico_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tb_servico` (`servico_id`,`tipo_servico_id`,`servico_dt_cad`,`servico_hr_cad`,`servico_dt_ini`,`servico_dt_fim`,`servico_sob_demanda`,`servico_titulo`,`servico_resumo`,`servico_thumb`,`servico_thumb_desc`,`servico_fonte`,`servico_link_fonte`,`servico_agenda`,`servico_conteudo`) VALUES 
 (1,2,'2014-03-26','16:13:40','2014-03-30','2014-04-24','N','ServiÃ§o especial','um resumo do conteudo','20140326191340_novidades.jpg','um resumo do conteudo','','','0000-00-00','<p>\r\n	fasdkfj djf&ccedil;dlsksd f</p>\r\n<p>\r\n	sd</p>\r\n<p>\r\n	fsd</p>\r\n<p>\r\n	f sda</p>\r\n<p>\r\n	fds</p>\r\n<p>\r\n	f</p>\r\n<p>\r\n	sd</p>\r\n<p>\r\n	fim</p>\r\n');

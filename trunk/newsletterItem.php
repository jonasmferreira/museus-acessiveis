...
<div id="root" style="width:680px; margin:0 auto; background-color:#FFF;">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
    	<tr>
        	<td align="center" class="news-info" height="30" style="font-size:11px; color:#000;">
            	<span style="font-weight:bold;">Acessibilidade 360º: </span>Se você não consegue visualizar este e-mail, <a style="color: #FF0000; text-decoration: none !important;" href="<?=$linkAbsolute?>newsletter/<?=$aNewsletter['emailmkt_id'];?>/<?=$aNewsletter['emailmkt_emkt'];?>" target="_blank">clique aqui!</a>
            </td>
        </tr>
    </table>
		  ...
		  <tr>
			...
			<td style="background: url(<?=$linkAbsolute;?>img/emkt_title.png) left 35px no-repeat;padding:200px 0 0 0;" class="title" valign="middle" align="center">
				...
				<span style="background: #666;padding: 2px 5px;font-size: 13px;color: #FFF;margin: 0 0 0 10px;" id="edicao">
					<a style="color: #FFF;text-decoration: none !important;" href="<?=$linkAbsolute?>newsletter/<?=$aNewsletter['emailmkt_id'];?>/<?=$aNewsletter['emailmkt_emkt'];?>" target="_blank">
	...
	<div id="project" style="padding: 34px 31px 30px 16px;">
		...
		<a style="text-decoration: none !important;padding: 5px;background: #000;font-weight: bold;font-size: 14px;color: #FFF;" href="<?=$linkAbsolute;?>projeto/<?=$v['projeto_id'];?>/<?=$objEmkt->toNormaliza($v['projeto_titulo']);?>" class="saibamais">Leia mais</a>
		</div>
	</div>
	<?php } ?>
	...
	<div id="acessibilidade" style="margin: 0 0 10px 47px;width: 594px;padding: 0 0 5px 0;overflow: visible;background: url(<?=$linkAbsolute;?>img/emkt_access_bg_purple2.png) left bottom no-repeat;">
		<div class="box" style="padding: 10px 0 5px 0;background: url(<?=$linkAbsolute;?>img/emkt_access_bg_purple1.png) left top no-repeat;">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						<a style="padding: 5px;background: #000;font-weight: bold;font-size: 14px;color: #FFF;text-decoration: none !important;" href="<?=$linkAbsolute;?>glossario/<?=$v['glossario_id'];?>/<?=$objEmkt->toNormaliza($v['glossario_palavra']);?>" class="glossario">Conheça o Glossário da Acessibilidade</a>
					</td>
				</tr>
			</table>
			</div>
		...
		<table cellpading="0" cellspacing="0" border="0" width="87%" style="margin: 0 0 0 45px;padding:0; border:0;">
			...
			<tr>
				...
				<td width="403" class="news-resumo" style="padding: 0 0 50px 0;margin:0;">
					...
					<a style="text-decoration: none !important;padding: 5px;background: #000;font-weight: bold;font-size: 14px;color: #FFF;" href="<?=$linkAbsolute;?>novidade360/<?=$v['novidade_360_id'];?>/<?=$objEmkt->toNormaliza($v['novidade_360_titulo']);?>" class="saibamais">Saiba mais</a>                
				</td>
			</tr>
		  <?php } ?>
					...
					<ul class="news-list" style="margin:0; padding:0; border:0;display: block;">
						...
						<li style="display: block;margin: 0;padding: 10px 0;border-bottom: 1px solid #6f6f6e;">
							<h3 style="font-size:19px;font-weight:normal;margin:0;padding:0;" class="title">
								<a style="color: #28b297;font-size: 19px;font-style: italic;font-weight: bold;text-decoration: none !important;" href="<?=$linkAbsolute;?>novidade360/<?=$v['novidade_360_id'];?>/<?=$objEmkt->toNormaliza($v['novidade_360_titulo']);?>"><?=$v['novidade_360_titulo'];?></a>
							</h3>  
						</li>
						<?php } ?>
					</ul>
					<br class="clear" style="clear:both;" />            
					<a style="text-decoration: none !important;padding: 5px;background: #000;font-weight: bold;font-size: 14px;color: #FFF;" href="<?=$linkAbsolute;?>novidade360" class="saibamais" class="saibamais">Mais novidades</a>
				</td>
			</tr>
		</table>
	</div>
			...
			<table width=100% cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td valign="top" align="center" width="33%" height="240">
						...
						<div class="title">
							<a style="margin: 20px 0 0 0;font-size:17px;font-style: italic;font-weight: bold;color: #f37920;text-align: center;text-decoration: none !important;" href="<?=$v['item_link']?>">
								<?=$v['item_titulo']?>
							</a>
						</div>
					</td>

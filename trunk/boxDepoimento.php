...
?>
					<li>
						<strong tabIndex="104" class="description"><?=$v['depoimento_conteudo'];?></strong><br />
						<strong tabIndex="104" class="author"><?=$v['depoimento_autor'];?></strong><br />
						<strong tabIndex="104" class="company"><?=$v['depoimento_empresa'];?></strong>
					</li>
<?php			
				}
			?>

...
<head>
	<?php 
		...
		include_once("{$path_root_page}adm{$DS}class{$DS}acessibilidade.class.php");
		$objAcessibilidade = new acessibilidade();
		$nId = (isset($_REQUEST['texto_id'])?$_REQUEST['texto_id']:2);
		$objAcessibilidade->setValues(
			array(
				'texto_id'=>$nId
			)
		);
		$aAcessibilidade = $objAcessibilidade->getOne();
		//$objAcessibilidade->debug($aAcessibilidade);
...
<div id="root">
	...
	<div id="content-l">
        ...
        <div id="content" href="content" accesskey="3">
			...
			<div id="news360">
           	  <h1 tabIndex="31" class="orange-color">Acessibilidade</h1>
					<div id="content-news" class="content-box">
						<?=$aAcessibilidade['texto_conteudo'];?>
					</div>
        	</div>
        	<div class="clear"></div>
        </div>

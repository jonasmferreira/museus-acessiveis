...
-- Tempo de Geração: 22/03/2015 às 12:06:58
...
(6, 'Chegou', 0, '2014-12-02', '00:00:00', NULL, NULL, 'P', '', '', '8', 'S', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
DROP TABLE IF EXISTS `tb_emailmkt_old`;
...
DROP TABLE IF EXISTS `tb_novidade_360_galeria`;

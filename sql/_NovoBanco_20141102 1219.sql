...
--
-- Definition of table `tb_clipping`
--
...
--
-- Dumping data for table `tb_clipping`
--

/*!40000 ALTER TABLE `tb_clipping` DISABLE KEYS */;
INSERT INTO `tb_clipping` (`clipping_id`,`clipping_dt_agenda`,`clipping_exibir_listagem`,`clipping_dt`,`clipping_hr`,`clipping_titulo`,`clipping_titulo_sintese`,`clipping_resumo`,`clipping_thumb`,`clipping_thumb_desc`,`clipping_fonte`,`clipping_url_fonte`,`clipping_conteudo`,`clipping_exibir_banner`,`clipping_banner`,`clipping_banner_desc`,`clipping_exibir_destaque_home`,`clipping_destaque_home`,`clipping_destaque_home_desc`,`clipping_destaque_home_frase`) VALUES 
 (2,'2014-08-05','S','2014-08-24','15:30:34','Um Clipping de teste','Um clipping','UM resumo aquaquer','20140824183034_novidades.jpg','a descri vai aqui','Google','http://www.google.com.br','<p>\r\n	Aqui vai todo o conte&uacute;do do clipping.</p>\r\n','N','','','N','','',''),
 (3,'2014-08-20','S','2014-08-24','15:32:37','Dois Clipping de teste','Dois clipping','hahaha um resmo','20140824183237_novidades.jpg','a dsecriÃ§Ã£o','Uol','http://www.google.com.br','<p>\r\n	hfhasdfsdj sdkf sdk fsdaf jsdl e fim de papo</p>\r\n','N','','','N','','','');
/*!40000 ALTER TABLE `tb_clipping` ENABLE KEYS */;


--
-- Definition of table `tb_clipping_download`
--
...
--
-- Dumping data for table `tb_clipping_download`
--

/*!40000 ALTER TABLE `tb_clipping_download` DISABLE KEYS */;
INSERT INTO `tb_clipping_download` (`clipping_id`,`download_id`) VALUES 
 (2,1),
 (2,3),
 (3,3);
/*!40000 ALTER TABLE `tb_clipping_download` ENABLE KEYS */;


--
-- Definition of table `tb_clipping_tag`
--
...
--
-- Dumping data for table `tb_clipping_tag`
--

/*!40000 ALTER TABLE `tb_clipping_tag` DISABLE KEYS */;
INSERT INTO `tb_clipping_tag` (`clipping_id`,`tag_id`) VALUES 
 (2,1),
 (3,2),
 (2,3),
 (2,5);
/*!40000 ALTER TABLE `tb_clipping_tag` ENABLE KEYS */;
...
INSERT INTO `tb_contato` (`contato_id`,`contato_dt`,`contato_hr`,`contato_tipo_id`,`contato_nome`,`contato_link`,`contato_exibir`) VALUES 
 ...
 (4,'2014-08-08','00:20:14',6,'Museus AcessÃ­veis','http://www.museusacessiveis.com.br','S');
...
INSERT INTO `tb_curso_download` (`curso_id`,`download_id`) VALUES 
 (1,1);
...
INSERT INTO `tb_curso_extra` (`curso_id`,`extra_id`,`curso_extra_valor`) VALUES 
 (1,1,''),
 (1,2,'O campo de licitaÃ§Ãµes'),
 (5,1,''),
 (5,2,''),
 (6,1,''),
 (6,2,''),
 (9,1,'Um teste aqui'),
 (9,2,'o segundo teste aqui'),
 (10,1,''),
 (10,2,''),
 (11,1,''),
 (11,2,'');
...
--
-- Definition of table `tb_depoimento`
--
...
--
-- Dumping data for table `tb_depoimento`
--

/*!40000 ALTER TABLE `tb_depoimento` DISABLE KEYS */;
INSERT INTO `tb_depoimento` (`depoimento_id`,`depoimento_dt`,`depoimento_conteudo`,`depoimento_autor`,`depoimento_empresa`) VALUES 
 (2,'2014-08-16','Aqui vai o texto do Joy com um depoimento da hora.','Josenilson','Hey Joy!');
/*!40000 ALTER TABLE `tb_depoimento` ENABLE KEYS */;
...
CREATE TABLE `tb_download` (
  ...
  CONSTRAINT `FK_tb_download_cat` FOREIGN KEY (`download_categoria_id`) REFERENCES `tb_download_categoria` (`download_categoria_id`)
...
INSERT INTO `tb_download` (`download_id`,`download_titulo`,`download_tipo`,`download_tamanho`,`download_arquivo`,`download_dt`,`download_hr`,`download_tipo_desc`,`download_categoria_id`) VALUES 
 (1,'A ComunicaÃ§Ã£o dos Sentidos nos EspaÃ§os Culturais Brasileiros - Tese de Doutorado de Viviane Panelli Sarraf',1,'2554843.00','20140326143526_tesedigital.pdf','2014-03-26','14:35:26','PDF',4),
 (2,'NoÃ§Ã£o de competÃªncia e a formaÃ§Ã£o do aluno trabalhador',1,'10189318.00','20140608134209_104329.pdf','2014-06-08','13:42:09','PDF',1),
 (3,'ADM - Documento',7,'0.00','http://www.museusacessiveis.com.br/sitenovo/arquivosDown/ADM - Museus AcessÃ­veis.pdf','2014-08-09','20:37:52','Link Internet',5),
 (4,'Mais um teste',7,'0.00','http://www.museusacessiveis.com.br/sitenovo/arquivosDown/ADM - Museus AcessÃ­veis.pdf','2014-08-10','12:11:11','Link Internet',1),
 (5,'Uma publicaÃ§Ã£o',1,'12603.00','20140817192348_169storyboards4.pdf','2014-08-17','16:23:48','PDF',3);
/*!40000 ALTER TABLE `tb_download` ENABLE KEYS */;


--
-- Definition of table `tb_download_categoria`
--
...
CREATE TABLE `tb_download_categoria` (
  ...
  PRIMARY KEY (`download_categoria_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `tb_download_categoria`
--

/*!40000 ALTER TABLE `tb_download_categoria` DISABLE KEYS */;
INSERT INTO `tb_download_categoria` (`download_categoria_id`,`download_categoria_titulo`) VALUES 
 ...
 (4,'Imprensa'),
 (5,'Leis');
/*!40000 ALTER TABLE `tb_download_categoria` ENABLE KEYS */;
...
CREATE TABLE `tb_emailmkt_conferencia` (
  ...
  CONSTRAINT `fk_emailmkt_conferencia_01` FOREIGN KEY (`emailmkt_id`) REFERENCES `tb_emailmkt_old` (`emailmkt_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Definition of table `tb_emailmkt_old`
--

DROP TABLE IF EXISTS `tb_emailmkt_old`;
CREATE TABLE `tb_emailmkt_old` (
...
--
-- Dumping data for table `tb_emailmkt_old`
--

/*!40000 ALTER TABLE `tb_emailmkt_old` DISABLE KEYS */;
INSERT INTO `tb_emailmkt_old` (`emailmkt_id`,`emailmkt_titulo`,`emailmkt_qtde_enviada`,`emailmkt_dt_agendada`,`emailmkt_hr_agendada`,`emailmkt_dt_disparo`,`emailmkt_hr_disparo`,`emailmkt_status`,`emailmkt_servico_ids`,`emailmkt_projeto_ids`,`emailmkt_glossario_ids`,`emailmkt_novidade360_id`,`emailmkt_novidade360_ids`,`emailmkt_agenda_ids`,`emailmkt_arq_fisico`,`emailmkt_aqui_tem_titulo`,`emailmkt_aqui_tem_resumo`,`emailmkt_aqui_tem_thumb`,`emailmkt_aqui_tem_url`,`emailmkt_propaganda_img`,`emailmkt_propaganda_url`) VALUES 
 (2,'Teste 01',0,'2014-08-21','00:00:00',NULL,NULL,'P','','2','4',10,'8,13,12','6=>N,10=>N,11=>N','','A sessÃ£o do aqui tem','hjfhasdj fhadf jsda hdskj lorem ipsum','20140808223949_emkt_aquitem_imagem.jpg','http://www.uol.com.br','20140808223949_emkt_imagem.png','http://www.uol.com.br');
/*!40000 ALTER TABLE `tb_emailmkt_old` ENABLE KEYS */;


--
-- Definition of table `tb_emkt_noticia`
--
...
--
-- Dumping data for table `tb_emkt_noticia`
--

/*!40000 ALTER TABLE `tb_emkt_noticia` DISABLE KEYS */;
INSERT INTO `tb_emkt_noticia` (`emkt_noticia_id`,`emkt_noticia_dt`,`emkt_noticia_hr`,`emkt_noticia_titulo`,`emkt_noticia_titulo_sintese`,`emkt_noticia_resumo`,`emkt_noticia_thumb`,`emkt_noticia_thumb_desc`,`emkt_noticia_fonte`,`emkt_noticia_url_fonte`,`emkt_noticia_conteudo`) VALUES 
 (1,'2014-10-12','23:22:56','Uma notÃ­cia para o newsletter','Noticia news','um resumÃ£o. e fim mesmo.','20141026231747_novidades.jpg','A descr do thumb.','UOL','www.uol.com.br','<p>\r\n	Aqui vai o conte&uacute;do geral</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	sd</p>\r\n<p>\r\n	fdsa</p>\r\n<p>\r\n	fsda</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	lalala e fim. Agora vai mesmo.</p>\r\n'),
 (2,'2014-10-02','14:07:46','Duas notÃ­cia para o newsletter','Noticia news','hfhadhfadshsd e resumo.','20141027160746_novidades.jpg','hfadshfasdhfs e fim da descr.','UOL','www.uol.com.br','<p>\r\n	Aqui o conte&uacute;do para aparecer no emkt e pronto.</p>\r\n');
/*!40000 ALTER TABLE `tb_emkt_noticia` ENABLE KEYS */;
...
CREATE TABLE `tb_imprensa` (
  ...
  CONSTRAINT `FK_tb_imprensa_1` FOREIGN KEY (`novidade_360_id`) REFERENCES `tb_novidade_360` (`novidade_360_id`)
...
INSERT INTO `tb_imprensa` (`imprensa_id`,`imprensa_assessoria_nome`,`imprensa_assessoria_telefone`,`imprensa_assessoria_email`,`novidade_360_id`,`imprensa_nossos_numeros`) VALUES 
 (1,'JoÃ£o Batista Macedo Jr.','(11) 98554-7324','fessorjoao@gmail.com',8,'<p>\r\n	Aqui vai o conte&uacute;dos dos nossos n&uacute;meros... e fim.</p>\r\n');
/*!40000 ALTER TABLE `tb_imprensa` ENABLE KEYS */;


--
-- Definition of table `tb_imprensa_old`
--

DROP TABLE IF EXISTS `tb_imprensa_old`;
CREATE TABLE `tb_imprensa_old` (
...
--
-- Dumping data for table `tb_imprensa_old`
--

/*!40000 ALTER TABLE `tb_imprensa_old` DISABLE KEYS */;
INSERT INTO `tb_imprensa_old` (`imprensa_id`,`imprensa_titulo`,`imprensa_tipo`,`imprensa_tamanho`,`imprensa_arquivo`,`imprensa_dt`,`imprensa_hr`) VALUES 
 (1,'Um teste de imprensa',1,'12603.00','20140810231658_169storyboards4.pdf','2014-08-10','20:14:59');
/*!40000 ALTER TABLE `tb_imprensa_old` ENABLE KEYS */;
...
--
-- Dumping data for table `tb_novidade_360_download`
--

/*!40000 ALTER TABLE `tb_novidade_360_download` DISABLE KEYS */;
INSERT INTO `tb_novidade_360_download` (`novidade_360_id`,`download_id`) VALUES 
 (12,2),
 (12,4);
/*!40000 ALTER TABLE `tb_novidade_360_download` ENABLE KEYS */;
...
--
-- Definition of table `tb_quemsomos`
--
...
--
-- Dumping data for table `tb_quemsomos`
--
...
--
-- Definition of table `tb_release`
--
...
--
-- Dumping data for table `tb_release`
--

/*!40000 ALTER TABLE `tb_release` DISABLE KEYS */;
INSERT INTO `tb_release` (`release_id`,`release_dt_agenda`,`release_exibir_listagem`,`release_dt`,`release_hr`,`release_titulo`,`release_titulo_sintese`,`release_resumo`,`release_thumb`,`release_thumb_desc`,`release_fonte`,`release_url_fonte`,`release_conteudo`,`release_exibir_banner`,`release_banner`,`release_banner_desc`,`release_exibir_destaque_home`,`release_destaque_home`,`release_destaque_home_desc`,`release_destaque_home_frase`) VALUES 
 (1,'2014-08-07','S','2014-07-18','14:34:24','Um release de teste','Um teste','Um resumo do release 1 de teste','20140824172708_novidades.jpg','a descriÃ§Ã£o do thumb','Uol','http://www.uol.com.br','<p>\r\n	Aqui vai o texto completo do release.</p>\r\n','N','','','S','20140824172709_destaque.jpg','Aqui a descr da imagem','Uma frase bacana de efeito.'),
 (2,'2014-08-02','S','2014-08-24','15:33:55','Dois release de teste','Dois teste','fdshfhasd hsd e resumo','20140824183355_novidades.jpg','aqui a descriÃ§Ã£o','Terra','http://www.terra.com.br','<p>\r\n	hsahaha e fim de papo o cnte&uacute;do est&aacute; pronto.</p>\r\n','N','','','N','','','');
/*!40000 ALTER TABLE `tb_release` ENABLE KEYS */;


--
-- Definition of table `tb_release_download`
--
...
--
-- Dumping data for table `tb_release_download`
--

/*!40000 ALTER TABLE `tb_release_download` DISABLE KEYS */;
INSERT INTO `tb_release_download` (`release_id`,`download_id`) VALUES 
 (1,2),
 (2,2),
 (1,3),
 (1,5);
/*!40000 ALTER TABLE `tb_release_download` ENABLE KEYS */;


--
-- Definition of table `tb_release_tag`
--
...
--
-- Dumping data for table `tb_release_tag`
--

/*!40000 ALTER TABLE `tb_release_tag` DISABLE KEYS */;
INSERT INTO `tb_release_tag` (`release_id`,`tag_id`) VALUES 
 (1,1),
 (1,5),
 (2,5),
 (2,7);
/*!40000 ALTER TABLE `tb_release_tag` ENABLE KEYS */;
...
INSERT INTO `tb_servico_extra` (`servico_id`,`extra_id`,`servico_extra_valor`) VALUES 
 ...
 (9,1,''),
 (9,2,''),
 (10,1,'serÃ¡ que tÃ¡ funcionando'),
 (10,2,'talvez sim, mas acho que tÃ¡ certo.'),
 (12,1,''),
 (12,2,''),
 (14,1,''),
 (14,2,'');

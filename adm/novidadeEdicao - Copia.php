	...
	<form action="controller/novidade.controller.php" method="post" id="formSalvar" name="formSalvar" enctype="multipart/form-data">
		...
		<table cellpadding="0" cellspacing="0" id="formCadastro">
			<tbody>
				...
				<tr>
            		<td colspan="3">
						Imagem para Outdoor(517x227)<br />
						<?	if(is_file("../images/{$aRow['novidade_360_banner']}")):?>
						<span>(<a href="javascript:void(0)" rel="novidade_360_banner" class="delImg">Remover Imagem</a>)</span>
						<?	endif;?>
						<br />
				...
				<tr>
					<td colspan="3">
						Descrição da Imagem para Outdoor<br />
						<textarea name="novidade_360_banner_desc" id="novidade_360_banner_desc" rows="5" style="width:99%"><?=$aRow['novidade_360_banner_desc']?></textarea>
					</td>
				</tr>
				...
				<tr>
					<td colspan="3">
						...
						<textarea name="novidade_360_destaque_home_desc" id="novidade_360_destaque_home_desc" rows="5" style="width:99%"><?=$aRow['novidade_360_destaque_home_desc']?></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						Destaque Frase <br />
						<textarea name="novidade_360_destaque_home_frase" id="novidade_360_destaque_home_frase" rows="5" style="width:99%"><?=$aRow['novidade_360_destaque_home_frase']?></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="3">
